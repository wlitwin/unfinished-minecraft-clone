 ...
 *   0 - glm::vec3 - Vertex position
 *   1 - glm::vec3 - Normal for the vertex
 *   2 - glm::vec2 - Texture coordinate of the vertex
 *
...
public:
    ...
    void AddTriangle(const glm::vec3& p1, const glm::vec2& t1, const glm::vec3& n1,
                     const glm::vec3& p2, const glm::vec2& t2, const glm::vec3& n2,
                     const glm::vec3& p3, const glm::vec2& t3, const glm::vec3& n3);

    void AddTriangle(const glm::vec3& p1, const glm::vec3& n1,
    ...
    void AddQuad(const glm::vec3& p1, const glm::vec2& t1, const glm::vec3& n1,
                 const glm::vec3& p2, const glm::vec2& t2, const glm::vec3& n2,
                 const glm::vec3& p3, const glm::vec2& t3, const glm::vec3& n3,
                 const glm::vec3& p4, const glm::vec2& t4, const glm::vec3& n4);

    void AddQuad(const glm::vec3& p1, const glm::vec3& n1,
                 const glm::vec3& p2, const glm::vec3& n2, 
                 const glm::vec3& p3, const glm::vec3& n3,
    ...
    void AddPoint(const glm::vec3& p, const glm::vec3& norm);

    void AddPoint(const glm::vec3& p, const glm::vec3& norm, const glm::vec2& texCoord);
     ...
     *   0 - glm::vec3 - The vertex
     *   1 - glm::vec3 - The normal
     *   2 - glm::vec2 - The texture coordinate
     */
    void Render();
